...
def cell_definition(e):
    ...
    discoverer = '<i class="fa fa-graduation-cap"></i> %s - %s' % (
        e["Discoverer"],
        e["Year of Discovery"],
    )
    electron = '<i class="fa fa-dot-circle-o"></i> %s' % (
        e["Electron Configuration"]
    )

    meta = (
        '<div class="bg"> <p class="title">%s </p>\
    ...
    cell = (
        '\t\t<td class="%s"><div class="cell-content">%s</br>%s</br>%s</div>%s</td>\n'
...
html.write(
    '<h4><a id="github" target="_blank" href="https://github.com/leonard-seydoux"><i class="fa fa-github"></i>leonard-seydoux</a></h4>\n'
)
